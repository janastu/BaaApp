...
import janastu.android.followsheep.db.model.Track;
import janastu.android.followsheep.db.model.Track.OSMVisibility;
import janastu.android.followsheep.gpx.ExportToStorageTask;
import janastu.android.followsheep.gpx.ExportToTempFileTask;
import janastu.android.followsheep.gpx.GpxToStorageTask;
import janastu.android.followsheep.osm.OpenStreetMapConstants;
import janastu.android.followsheep.osm.RetrieveAccessTokenTask;
import janastu.android.followsheep.osm.RetrieveRequestTokenTask;
import janastu.android.followsheep.osm.UploadToOpenStreetMapTask;
...
public class OpenStreetMapUpload extends TrackDetailEditor {
	...
	public void uploadToOsm() {
		new GpxToStorageTask(this,trackId).execute();
		new ExportToTempFileTask(this, trackId) {
			...
			protected void executionCompleted() {
				...
				new UploadToOpenStreetMapTask(OpenStreetMapUpload.this, trackId, this.getTmpFile(),
				this.getFilename(), etDescription.getText().toString(), etTags.getText().toString(),
				OSMVisibility.fromPosition(OpenStreetMapUpload.this.spVisibility.getSelectedItemPosition())).execute();
			}
		}.execute();
	} 
