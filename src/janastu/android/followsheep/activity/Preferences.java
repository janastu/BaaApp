...
public class Preferences extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// User names
				EditTextPreference userNamePref = (EditTextPreference) findPreference(OSMTracker.Preferences.KEY_USER_NAME);
				userNamePref.setSummary(prefs.getString(OSMTracker.Preferences.KEY_USER_NAME, OSMTracker.Preferences.VAL_USER_NAME));
				userNamePref.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference, Object newValue) {
						...
						// Set summary with the new value
						preference.setSummary((String) newValue);
				...
				populateLayoutPreference(userNamePref.getText());
