...
public class OpenStreetMapConstants {
	...
	private static final String OSM_API_URL_DEV = "http://followsheep-pantoto-org-bxzguanshjde.runscope.net/index.php";
	/*private static final String OSM_API_URL = (DEV_MODE) ? OSM_API_URL_DEV : OSM_API_URL_PROD;*/
	private static final String OSM_API_URL = OSM_API_URL_DEV;
