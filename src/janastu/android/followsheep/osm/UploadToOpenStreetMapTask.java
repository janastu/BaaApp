package janastu.android.followsheep.osm;
...
import janastu.android.followsheep.osm.ProgressMultipartEntity.ProgressListener;
import janastu.android.followsheep.util.DialogUtils;
...
public class UploadToOpenStreetMapTask extends AsyncTask<Void, Void, Void> {
	...
	/*public UploadToOpenStreetMapTask(Activity activity,
		...
		public UploadToOpenStreetMapTask(Activity activity, 
				long trackId, File gpxFile, String filename,
				String description, String tags, OSMVisibility visibility) {
	...
	protected void onPreExecute() {
		try {
            ...
            Log.v(TAG, "Request entity: " + request );
	...
	protected Void doInBackground(Void... params) {
		try {
			...
			Log.v(TAG, "Response: " +  response.getStatusLine().getReasonPhrase());
		} catch (Exception e) {
